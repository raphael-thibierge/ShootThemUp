...
const int SETTINGSVIEW_DIFFICULTY_1_X = 220;
const int SETTINGSVIEW_DIFFICULTY_1_Y = SETTINGSVIEW_DIFFICULTY_Y;
const int SETTINGSVIEW_DIFFICULTY_2_X = SETTINGSVIEW_DIFFICULTY_1_X+ BUTTON_WIDTH +50;
const int SETTINGSVIEW_DIFFICULTY_2_Y = SETTINGSVIEW_DIFFICULTY_Y;
const int SETTINGSVIEW_DIFFICULTY_3_X = SETTINGSVIEW_DIFFICULTY_2_X+ BUTTON_WIDTH +50;
